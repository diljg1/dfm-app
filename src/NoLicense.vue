<template>
    <div v-if="noLicense" class="uk-card uk-card-default uk-padding-small">
        <div
            class="cursor-pointer uk-text-center uk-margin-remove-top"
    ...
    computed: {
        ...
        trialEndDate() {
            return this.trialEnd
                ? new Date(this.trialEnd).toLocaleDateString()
                : '';
        },
        licenseLink() {
            return this.$locale === 'nl-NL'
                ? this.links.license_link_nl
                : this.links.license_link;
        },
        ...mapState({
